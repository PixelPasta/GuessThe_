...
app.get('/flag', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var object, Headers, headers, fetched, order;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 6;
          return fetch("https://".concat(req.get('host'), "/countries.json"), {
            method: 'GET',
            headers: headers
          });
        case 6:
        ...
        case 9:
          ...
          object.flag1 = "http://purecatamphetamine.github.io/country-flag-icons/3x2/".concat(fetched.Data.altSpellings[0], ".svg");
          _context2.next = 17;
          return fetch("https://".concat(req.get('host'), "/countries.json"), {
            method: 'GET',
            headers: headers
        ...
        case 20:
          fetched = _context2.sent;
          object.flag2 = "http://purecatamphetamine.github.io/country-flag-icons/3x2/".concat(fetched.Data.altSpellings[0], ".svg");
          _context2.next = 24;
          return fetch("https://".concat(req.get('host'), "/countries.json"), {
            method: 'GET',
            headers: headers
        ...
        case 27:
          fetched = _context2.sent;
          object.flag3 = "http://purecatamphetamine.github.io/country-flag-icons/3x2/".concat(fetched.Data.altSpellings[0], ".svg");
          object.op1 = "./correct/?ans=".concat(object.country, "&flag=").concat(object.flag1);
          object.op2 = "./incorrect/?ans=".concat(object.country, "&flag=").concat(object.flag1);
          object.op3 = "./incorrect/?ans=".concat(object.country, "&flag=").concat(object.flag1);
        case 32:
          if (!(order == 2)) {
            _context2.next = 51;
            break;
        ...
        case 46:
          fetched = _context2.sent;
          object.flag3 = "http://purecatamphetamine.github.io/country-flag-icons/3x2/".concat(fetched.Data.altSpellings[0], ".svg");
          object.op1 = "./incorrect/?ans=".concat(object.country, "&flag=").concat(object.flag2);
          object.op2 = "./correct/?ans=".concat(object.country, "&flag=").concat(object.flag2);
          object.op3 = "./incorrect/?ans=".concat(object.country, "&flag=").concat(object.flag2);
        case 51:
          if (!(order == 3)) {
            _context2.next = 70;
            break;
        ...
        case 65:
          fetched = _context2.sent;
          object.flag2 = "http://purecatamphetamine.github.io/country-flag-icons/3x2/".concat(fetched.Data.altSpellings[0], ".svg");
          object.op1 = "./incorrect/?ans=".concat(object.country, "&flag=").concat(object.flag3);
          object.op2 = "./incorrect/?ans=".concat(object.country, "&flag=").concat(object.flag3);
          object.op3 = "./correct/?ans=".concat(object.country, "&flag=").concat(object.flag3);
        case 70:
...
app.get('/correct', /*#__PURE__*/function () {
...
app.get('/incorrect', /*#__PURE__*/function () {
...
app.get('/logo', /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var object, fetched, order;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          object = new Object();
          _context5.next = 3;
          return fetch("https://".concat(req.headers.host, "/brands"));
        case 3:
        ...
        case 28:
          ...
          object.op1 = "./LogoCorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img1);
          object.op2 = "./LogoIncorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img1);
          object.op3 = "./LogoIncorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img1);
        ...
        case 48:
          fetched = _context5.sent;
          object.img3 = fetched.answer;
          object.op1 = "./LogoIncorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img2);
          object.op2 = "./LogoCorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img2);
          object.op3 = "./LogoIncorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img2);
          res.render('logo', object);
        case 54:
          if (!(order == 3)) {
            _context5.next = 74;
        ...
        case 68:
          fetched = _context5.sent;
          object.img1 = fetched.answer;
          object.op1 = "./LogoIncorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img3);
          object.op2 = "./LogoInorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img3);
          object.op3 = "./LogoCorrect/?ans=".concat(object.brand, "&wiki=").concat(object.wiki, "&img=").concat(object.img3);
          res.render('logo', object);
        case 74:
        case "end":
...
app.get('/logoCorrect', /*#__PURE__*/function () {
...
app.get('/logoIncorrect', /*#__PURE__*/function () {
...
app.get('/color', /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var fs, path, ntcPath, ntcCode, object, fetched, order;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          console.time("Ok");
          fs = require('fs');
          path = require('path'); // Load the ntc.js file
          ntcPath = path.join(__dirname, 'ntc.js');
          ntcCode = fs.readFileSync(ntcPath, 'utf-8');
          eval(ntcCode);
          object = new Object();
          ...
          if (order == 1) {
            ...
            fetched = (Math.random() * 0xFFFFFF << 0).toString(16).padStart(6, '0');
            object.cl3 = fetched;
            object.op1 = "./colorcorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl1);
            object.op2 = "./colorincorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl1);
            object.op3 = "./colorincorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl1);
          }
          if (order == 2) {
            object.cl2 = fetched;
            fetched = (Math.random() * 0xFFFFFF << 0).toString(16).padStart(6, '0');
            ...
            fetched = (Math.random() * 0xFFFFFF << 0).toString(16).padStart(6, '0');
            object.cl3 = fetched;
            object.op1 = "./colorincorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl2);
            object.op2 = "./colorcorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl2);
            object.op3 = "./colorincorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl2);
          }
          if (order == 3) {
            object.cl3 = fetched;
            fetched = (Math.random() * 0xFFFFFF << 0).toString(16).padStart(6, '0');
            ...
            object.op1 = "./colorincorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl3);
            object.op2 = "./colorincorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl3);
            object.op3 = "./colorcorrect/?ans=".concat(object.ans, "&cl=").concat(object.cl3);
          }
...
app.get('/colorcorrect', /*#__PURE__*/function () {
...
app.get('/colorincorrect', /*#__PURE__*/function () {
...
app.get('/brands', /*#__PURE__*/function () {
      ...
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          brands = [{
            ...
            hint: 'C_S',
            clue: "American\xA0commercial broadcast\xA0television\xA0and\xA0radio network.|Referred to as the \"Eye Network\", in reference to the company's iconic logo, in use since 1951.",
            easy: true
          }, {
...
app.get('/countries.json', /*#__PURE__*/function () {
